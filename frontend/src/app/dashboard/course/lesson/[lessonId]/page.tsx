      ...
      <div className="flex flex-col flex-1">
        ...
        <main className="flex-1 p-6 bg-white overflow-y-auto m-4 rounded-lg shadow-md">
          ...
          <div className="flex justify-between mt-10">
            <Button type="button" disabled={!previousLesson} className={`px-6 py-2 rounded ${previousLesson ? 'bg-gray-300 text-gray-800 hover:bg-gray-400' : 'bg-gray-200 text-gray-400 cursor-not-allowed'}`} onClick={() => previousLesson && router.push(`/dashboard/course/lesson/${previousLesson.lesson.id}`)}>
              ← Previous
            </Button>
            <Button
              type="button"
              ...
              onClick={async () => {
                  ...
                  try {
                    ...
                    setTimeout(() => {
                      router.push(`/dashboard/course/lesson/${nextLesson.lesson.id}`);
                    }, 300);
                  } catch (err) {
          ...
          {showCompleteAnimation && (
            <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
              <div className="bg-white p-8 rounded-lg shadow-lg text-center max-w-lg">
                ...
                <Button onClick={() => router.push('/dashboard/course')} className="mt-6 bg-green-600 text-white hover:bg-green-700">
                  Kembali ke Course
                </Button>
              </div>
            </div>
