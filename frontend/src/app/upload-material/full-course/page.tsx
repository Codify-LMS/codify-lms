...
import UploadCourseForm from '../UploadCourseForm/index'; // Perhatikan path relatif
import UploadModuleForm from '../UploadModuleForm/index'; // Perhatikan path relatif
import UploadLessonForm from '../UploadLessonForm/index'; // Perhatikan path relatif
